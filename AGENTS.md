...
streams the ABR ABN Bulk Extract XML in, joins it with **ten enrichment sources** —
...
AusTender government-contract spend, and the ATO Corporate Tax Transparency + R&D Tax
Incentive workbooks (see `docs/DATA-SOURCES.md`) — flattens to one document per ABN,
