...
streams the ABR ABN Bulk Extract XML in, joins it with **thirteen enrichment
...
representative registers, and the WGEA reporting-organisations list (see
`docs/DATA-SOURCES.md`) — flattens to one document per ABN, streams out validated
